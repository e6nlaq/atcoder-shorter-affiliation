...
- **カスタマイズ可能**: ブラウザの拡張機能メニュー（Tampermonkey 等）から、省略の基準となる幅（デフォルト: 20）をいつでも変更できます。
...
2. ユーザースクリプトマネージャーのメニュー（Tampermonkeyのアイコンをクリック）から **「省略文字数の設定 (AtCoder Shorter Affiliation)」** を選択します。
